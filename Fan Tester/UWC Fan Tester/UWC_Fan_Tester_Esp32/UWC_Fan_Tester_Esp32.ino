...
const int sensorPin = 25;  // Analog pin for RPM sensor
...
void loop() {
  ...
  if (elapsedTime >= 1000) {
    ...
    // Display the logo
    display.drawBitmap(75, 0, uwc_logo, LOGO_WIDTH, LOGO_HEIGHT, SSD1306_WHITE);

    display.setTextSize(1.5);
    display.println(" Fan Tester ");
    display.println("");

    display.setTextSize(2);
    display.print("  RPM:");
     display.drawRect(0, 30, SCREEN_WIDTH - 8, 20, SSD1306_WHITE);  // Draw border around RPM print area
    display.print(rpm);
