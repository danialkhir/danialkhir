...

            {
...

                {
					...
					if (Console.ReadKey().Key != ConsoleKey.Y)
					{
						...
						Write("SENS:CORR:COLL:THRU 1,2;*OPC?");
						Write("SENS:CORR:COLL:SAVE 0");
						Console.WriteLine("871 Calibration done");
						goto Ready;
					}
					...
					Console.WriteLine("Wait for 3 full sweep...");
				   	Console.WriteLine("Data Ready or Hold?(3/Y/N/H)");
					if(Console.ReadKey().Key!= ConsoleKey.W){
					Write("INIT:IMM;*OPC?");
					Write("INIT:IMM;*OPC?");
					Write("INIT:IMM;*OPC?");
					Console.WriteLine("3 Sweep Complete");
					Console.WriteLine("Saving Necessary Files...");
					String FileName;
					String FullPNG;
					String FullCSV;
