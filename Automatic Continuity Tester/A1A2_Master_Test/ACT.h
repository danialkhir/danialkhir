void saveResultRes(float R1,int S1,float R2,int S2, float R3,int S3){
...
void receiveRes(){
  ...
  int Rs3=Wire.read();
  float R1=R1k/1000;
  String R1s=String(R1);
  String Rs1s=String(Rs1);
  float R2=R2k/1000;
  String R2s=String(R2);
  String Rs2s=String(Rs2);
  float R3=R3k/1000;
  String R3s=String(R3);
  String Rs3s=String(Rs3);
  Serial.println("Save Res Result");
  saveResultRes(R1,Rs1,R2,Rs2,R3,Rs3);
  resString=R1s + "," + Rs1s + "," + R2s + "," + Rs2s +","+ R3s +","+ Rs3s +"\n";
...
void resStat(int Stts,int Rcount){
  sttString=String(Stts)+ "," + String(Rcount)+"\n";
  }
void ResTest(){
